...
const AdminChat = () => {
  ...
  const selectedChannelStorageKey = useMemo(
    () => `chat:selected:admin:${String(currentUserId || 'anonymous').trim() || 'anonymous'}`,
    [currentUserId]
  );
  ...
  useEffect(() => {
    ...
    socket.on('message:new', (message) => {
      // This socket joins a single conversation room for this page,
      // so room membership is a more reliable filter than raw id shape checks.
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 text-left min-w-0">
          <p className={`text-sm font-bold truncate ${isActive ? 'text-[#d7a444]' : 'text-gray-700'}`}>{contact?.name || 'Unknown'}</p>
    ...
    <div className="flex h-[calc(100vh)] bg-slate-50 overflow-hidden">
              ...
              <div key={group.key} className="space-y-1">
                ...
                >
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    {groupUnreadCount > 0 && (
                      <span className="inline-flex min-w-5 h-5 items-center justify-center px-1.5 rounded-full text-[10px] font-black leading-none bg-[#0b2d49] text-white normal-case tracking-normal">
      ...
      <div className="flex-1 flex flex-col bg-slate-50 relative">
        <div className="bg-white px-8 py-5 border-b border-gray-100 flex justify-between items-center shadow-sm z-10">
          ...
          {CALLS_ENABLED && <div className="flex items-center gap-2">
            <button
              ...
              className="p-2.5 rounded-full border border-gray-200 text-gray-600 hover:text-[#0b2d49] hover:border-[#0b2d49]/30 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        ...
        {CALLS_ENABLED && callSession && (
          <div className="absolute inset-0 z-20 bg-[#0b2d49]/55 backdrop-blur-sm flex items-center justify-center p-6">
              ...
              <div className="p-6 space-y-5">
                {callSession.callType === 'video' ? (
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-gray-50 p-8 text-center">
                    <div className="w-20 h-20 rounded-full bg-[#0b2d49] text-white mx-auto flex items-center justify-center text-xl font-black uppercase">
