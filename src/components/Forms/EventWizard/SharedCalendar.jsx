...
import { isDateHighDemand } from '../../../data/planningWizardData';

const SharedCalendar = ({ selectedDate, onChange, minDateString, onClose }) => {
    ...
    const handleDateClick = (dateStr) => {
        ...
        if (isDateHighDemand(dateStr)) {
            toast('Premium Selection: This high-demand date carries a dynamic pricing adjustment.', {
                icon: '💸',
                duration: 3000,
                style: {
                    borderRadius: '15px',
    ...
    const renderCalendar = () => {
        ...
        for (let day = 1; day <= daysCount; day++) {
            ...
            const isHighPrice = isDateHighDemand(dateStr);
    ...
    return (
        <motion.div
            ...
            className="absolute top-full right-0 mt-4 z-[100] bg-white rounded-[25px] shadow-2xl border border-teal-900/5 p-4 w-[280px]"
