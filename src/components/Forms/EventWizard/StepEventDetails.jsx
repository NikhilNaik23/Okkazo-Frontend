        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase mb-2">No of Guests <span className="text-red-500">*</span></label>
                        <input
                            type="number"
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#d7a444] focus:ring-4 focus:ring-[#d7a444]/10 outline-none transition-all placeholder:text-gray-300"
                            placeholder="e.g. 100"
