    ...
    return (
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h2 className="flex items-center gap-3 font-bold text-lg mb-6">
                <div className="text-white bg-[#09637E] w-6 h-6 rounded flex items-center justify-center text-[10px]">🎫</div>
                Ticket Categories
            </h2>
            <div className="space-y-4">
                    ...
                    <div key={ticket.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end animate-in fade-in slide-in-from-top-2 duration-300">
                        <div className="md:col-span-5">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:border-[#088395] outline-none"
                            />
                        </div>
                ...
                <button
                    ...
                    className="w-full py-4 mt-2 border-2 border-dashed border-[#09637E] rounded-xl text-[#09637E] font-bold flex items-center justify-center gap-2 hover:bg-[#09637E]/5 transition-all active:scale-[0.98]"
                >
                    <div className="w-5 h-5 rounded-full bg-[#09637E] text-white flex items-center justify-center text-xs">
                        <BsPlus size={18} />
                    </div>
                    Add Category
                </button>
