...
import { fetchCurrentUser, selectIsAuthenticated, selectUserRole, selectIsLoading, selectUser } from '../../store/slices/authSlice';
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#e9eff1]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="font-bold text-gray-400 uppercase tracking-widest text-xs">Verifying access...</p>
                </div>
            </div>
        );
    }
