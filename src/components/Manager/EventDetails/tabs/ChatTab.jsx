            ...
            <div className="flex-1 flex flex-col bg-slate-50 relative">
                                            ...
                                            {isMe ? (
                                                <div className="flex flex-col items-end gap-1">
                                                    ...
                                                    <div className="flex items-center gap-1 mr-12">
                                                        ...
                                                        {(msg.status === 'delivered' || msg.status === 'read') && <CheckCheck size={12} className={msg.status === 'read' ? 'text-green-500' : 'text-gray-400'} />}
                                                    </div>
                                                </div>
                                            ) : (
                ...
                <div className="p-4 bg-white border-t border-gray-100">
                    <div className="max-w-4xl mx-auto">
                        <div className={`bg-gray-100 rounded-[1.5rem] px-2 py-1.5 flex items-center gap-1 border border-transparent transition-all relative ${currentContact ? 'focus-within:border-[#0b2d49]/10 focus-within:bg-gray-50' : 'opacity-50 pointer-events-none'}`}>
                            <input
                                type="file"
                                ref={fileInputRef}
