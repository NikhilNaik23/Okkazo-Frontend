...
const Footer = () => {
    ...
    privacy: {
      ...
      content: (
        <>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">1. Information We Collect</h4>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">2. How We Use Your Information</h4>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">3. Data Security</h4>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">4. Contact Us</h4>
    ...
    terms: {
      ...
      content: (
        <>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">1. Acceptance of Terms</h4>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">2. User Accounts</h4>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">3. Event Guidelines</h4>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">4. Refunds and Cancellations</h4>
          ...
          <h4 className="font-bold text-lg mb-2 text-primary">5. Limitation of Liability</h4>
  ...
  return (
    <>
      <footer id="public-footer" className="bg-primary text-white py-10 relative z-30">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white text-gray-800 w-full max-w-2xl max-h-[80vh] overflow-y-auto rounded-3xl shadow-2xl animate-scale-up">
            <div className="sticky top-0 bg-white/95 backdrop-blur-md px-8 py-5 border-b border-gray-100 flex justify-between items-center z-10">
              ...
              <button
                onClick={closeModal}
                className="w-10 h-10 rounded-full bg-gray-100 hover:bg-surface text-gray-500 hover:text-primary flex items-center justify-center transition-colors"
              >
                <FaTimes size={18} />
              </button>
            </div>
            ...
            <div className="sticky bottom-0 bg-white px-8 py-4 border-t border-gray-100 flex justify-end">
              <button
                onClick={closeModal}
                className="px-6 py-2 bg-primary text-white rounded-xl hover:bg-[#08556d] transition-colors font-semibold"
              >
                Close
              </button>
            </div>
