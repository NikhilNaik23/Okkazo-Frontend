...
const Navbar = () => {
  ...
  useEffect(() => {
    const updateSavedCount = () => {
      try {
        ...
        console.error("Error reading saved items from localStorage", e);
      }
    };
    ...
    return () => {
      ...
      window.removeEventListener('savedUpdated', updateSavedCount);
    };
  }, []);
  ...
  return (
    <>
      <SavedSidebar isOpen={isSavedOpen} onClose={() => setIsSavedOpen(false)} />
